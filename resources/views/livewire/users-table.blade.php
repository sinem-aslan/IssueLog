            ...
            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                <thead class="bg-gray-50 sticky top-0"> <!-- Başlıkların kaydırma sırasında sabit kalması için -->
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 font-medium text-gray-900 w-48">E-posta</th>
                        <th scope="col" class="px-6 py-3 font-medium text-gray-900 w-40">Birim</th>
                        <th scope="col" class="px-6 py-3 font-medium text-gray-900 w-56">Açıklama</th>
                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                    @forelse ($users as $user)
                        <tr class="hover:bg-gray-50">
                            ...
                            <!-- E-posta -->
                            <td class="px-6 py-3 w-48">{{ $user->email }}</td>
                            <!-- Birim -->
                            <td class="px-6 py-3 w-40">{{ $user->department?->name ?? 'Bilinmiyor' }}</td>
                            <!-- Açıklama -->
                            <td class="px-6 py-3 w-56 max-w-xs align-top">
                                @php
