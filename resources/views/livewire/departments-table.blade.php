<div class="mt-8 mx-8 p-6 rounded shadow">
    ...
    <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md max-w-2xl mx-auto px-4 p-4">
            ...
            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                <thead class="bg-gray-50 sticky top-0"> <!-- Başlıkların kaydırma sırasında sabit kalması için -->
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 font-medium text-gray-900 w-60">İsim</th>
                        <th scope="col" class="px-6 py-3 font-medium text-gray-900 w-70">Açıklama</th>
                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                    @forelse ($departments as $department)
                        <tr class="hover:bg-gray-50">
                            ...
                            <!-- İsim -->
                            <td class="px-6 py-4 w-60">{{ $department->name }}</td>
                            <!-- Açıklama -->
                            <td class="px-6 py-3 w-70 max-w-xs align-top">
                                @php
