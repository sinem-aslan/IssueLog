                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div class="md:col-span-1 flex flex-col gap-6">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">10 haneli olmalı, 0 ile başlamamalı.</p>
                                ...
                                <div>
                                    <label class="inline-flex items-center mt-2">
                                        ...
                                        <span class="ml-2 text-sm text-gray-700" style="color: red">ACİL</span>
                                    </label>
            ...
            <table class="border-collapse bg-white text-left text-sm text-gray-500"
                ...
                <thead class="bg-gray-50 sticky top-0" style="z-index: 20;">
                    <tr>
                        ...
                        @endphp
                        <th scope="col" class="px-6 py-3 font-medium text-gray-900" style="width: 8%;">İşlemler</th>
